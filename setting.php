...
──── █▀█ █▀█ █─ █▀█────$kuning █─█ █─▄ █─█ ─▀▄────$red
──── ▀▀─ ▀─▀ ─▀ ▀─▀────$kuning █▀─ ▀▀▀ ─▀─ ▀▀─────$putih
creator:$ijo dodit$putih || code invite:$ijo F9NAmmRD7x$putih
...
──── █─ █─█ █ █─▀█──── █─ █─▄ █─█ █▀█────
──── ─▀ ─▀─ ▀ ▀──▀──── ─▀ ▀▀▀ ─▀─ ▀▀─────
creator: ".$ijo."dodit ".$pth."|| chanel: ".$ijo."adi bordir".$t;
...
──── █─█─█ █─█ █─▀█ █▀▀ ──█────── █─ █─█ █▀█ █▀▀────
──── ▀───▀ ─▀─ ▀──▀ ▀▀▀ ──▀────── ─▀ ─▀─ ▀▀─ ▀▀▀────
".$pth."creator: ".$ijo."dodit ".$pth."|| ".$ijo."subcribe chanel adi bordir".$t.$pth."invite : ".$ijo."YCUSP ".$pth."|| ".$ijo."W9HVQ
...
$flash="$red
 ...
 █▀──── █─▄──── █▀█──── ─▀▄──── █▀▄──── █─▀▌──── █─█
 ▀───── ▀▀▀──── ▀─▀──── ▀▀───── ▀─▀──── ▀▀▀───── ─▀─
$putih  creator :$ijo dodit$putih ||||| chanel :$turkis adi bordir".$t."$putih  support :$ijo sungging$putih ||||| chanel :$turkis sungging";
...
$yogov= $kuning."
 ...
 ──█── █─█ █─▀▌ █─█──── ─▀▄▀─ █ █─█ █▀▀ █─█
 ──▀── ─▀─ ▀▀▀─ ─▀───── ──▀── ▀ ▀▀─ ▀▀▀ ─▀─".$t.
$ijo."[ v 1.0 ] ".$putih."creator: ".$ijo."dodit".$t.">> subcribe chanel adi bordir".$t.">> subcribe chanel sungging".$t;
...
──── █▀▀──── █─█─█──── █─█──── █─▀█────
──── ▀▀▀──── ▀───▀──── ─▀───── ▀──▀────".$pth."
==[creator:".$ijo." dodit".$pth."]=|=".$tr."[ v : 1 . 0 ]".$pth."==".$t;
$stat_emon=true;
$auto_ref=true;
...
──── █▀▀ ─█─ █▀▄──── █▀ █▀█ █▐█▀ █─█─█ █▀▀ █▐█▀────
──── ▀▀▀ ─▀─ ▀─▀──── ▀─ ▀─▀ ▀─▀▀ ▀───▀ ▀▀▀ ▀─▀▀────
======[".$ijo." version 1.0".$tr." ]===[ creator:".$ijo." dodit".$tr." ]======".$t;
...
$epi=$kn."
 ...
 █▀▀──── █─█──── █──── █───── █▀█──── ─▀▄──── █▀▄
 ▀▀▀──── █▀───── ▀──── ─▀──── ▀─▀──── ▀▀───── ▀─▀
 ".$pth."[ ".$tr."v 1.0".$pth." ]==[ ".$tr."creator:".$ijo." dodit".$pth." ]==[".$tr." ref: ".$ijo."TVFG9W".$pth." ]".$t;
$msg_epi=$ijo."[•] update skrip https://github.com/dodit/epicash".$t.$pth."[support:".$tr." khairil".$pth."][Kode: ".$ijo."ZAVGFX]".$t;
$stat_epi1=true;
...
$cash= $br."
 ...
 █─ █▀█ ─▀▄ █▀▄──── █─█─█ █▀█ █─▄ █─▄ █▀▀ ─█─
 ─▀ ▀─▀ ▀▀─ ▀─▀──── ─▀─▀─ ▀─▀ ▀▀▀ ▀▀▀ ▀▀▀ ─▀─
====[".$ijo." version 1.0".$br." ]=[ creator:".$ijo." dodit".$br." ]====".$t;
...
$spbu=$pth."
 ...
 ======[ ".$tr."v 1.0".$pth." ]====[ ".$tr."creator: ".$br."dodit".$pth." ]======".$t;
$msg_spbu=$ijo."[•] enjoy your life";
$stat_spbu=true;

$cbn=$tr."                                                          
[v 1.0]".$red."_|_|_|".$pth."creator".$red."_|_|_|".$ijo." dodit".$red."_|".$kn." C B N".$red."_|              
     _|             _|    _|       _|_|    _|              
     _|             _|_|_|         _|  _|  _|              
     _|             _|    _|       _|    _|_|              
     _|_|_|         _|_|_|         _|      _|".$br."           
...
$newstom= $br."
 ...
 █─▀█ █▀▀ █─█─█ ─▀▄──── ─█─ █─█ █─█─█
 ▀──▀ ▀▀▀ ─▀─▀─ ▀▀───── ─▀─ ─▀─ ▀───▀".$pth."
    [v 1.0 ]=[".$tr." creator: ".$ijo."dodit".$pth." ]".$t.$tr;
...
----------------------------------------".$tr."
[===[ ".$pth."v 1.0".$tr." ]==[".$pth." creator:".$ijo." dodit".$tr." ]===]".$pth."
----------------------------------------".$t;
...
$yogop= $kuning."
 ...
 ──█── █─█ █─▀▌ █─█──── ─▀▄▀─ █ █─█ █▀▀ █─█
 ──▀── ─▀─ ▀▀▀─ ─▀───── ──▀── ▀ ▀▀─ ▀▀▀ ─▀─".$t.
$ijo."[ v ".$v." ] ".$putih."creator: ".$ijo."dodit".$t;
