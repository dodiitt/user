...
echo $kuning."[-] Hati-Hati dalam memggunakanya".$t;
echo $kuning."[-] Tidak untuk diperjual-belikan".$t;
echo $kuning."[-] Resiko sepenuhnya ditanggung sendiri".$t;
echo $kuning."[-] Enjoyyyyy".$t;
echo $red."[-] Jangan Lupa masukan kode invite nya".$t.$ijo.$t;
$stat_ads=true;
$sungging = $putih.'[*] '.$ijo.'Input '.$putih.'[-] code: '.$ijo.'N54577';
$ads= $putih.'[*] '.$ijo.'Masukan '.$putih.'[-] code: '.$ijo.'N54577';
$msgtoto = "[!] ".$t.$ijo."[•••••] sekilas info [••••••]
